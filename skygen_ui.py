...
class OrganizerWrapper:
    ...
    def getExecutables(self):
        ...
        """
        try:
            # The structure for accessing executables is typically direct on the organizer
            # or through game features, not via pluginList().plugin("pyCfg").settings("executables").
            # The correct way to get executables is self._organizer.getExecutables()
            # which returns a dictionary of IExecutableInfo objects keyed by name.
