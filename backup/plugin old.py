        ...
        if result == 1:
            ...
            if selected_output_type == "SkyPatcher YAML":
                ...
                if not target_mod_plugin_name:
                    self.dialog.showError("Plugin Selection Cancelled", f"Target mod plugin selection cancelled or failed for '{selected_target_name}'.")
                    return
                ...
                if pre_exported_xedit_json_path:
                    ...
                    actual_xedit_export_path = run_xedit_export(
                        ...
                        self.dialog.full_export_script_path, # h. Update display method to pass the single full_export_script_path to run_xedit_export:
