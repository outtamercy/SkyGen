...
# BOS categories — full spread, not just the cozy starter pack
# If a category feels too niche, trim it later. Better to have it and not need it.
BOS_CATEGORIES = {
    "Tree": {'TREE'},
    "Furniture": {'FURN', 'MSTT'},
    "Container": {'CONT'},
    ...
    "NPC": {'NPC_'},
    "Race": {'RACE'},
    "Body": {'ARMO', 'ARMA', 'NPC_', 'RACE'},  # old faithful — keeps existing M2M working
...
# BOS record map — mirrors the categories above so FID scan knows what to hunt
BOS_RECORD_MAP = {
    "Tree": {"TREE"},
    "Furniture": {"FURN", "MSTT"},
    "Container": {"CONT"},
    ...
    "Hair": {"HAIR", "HDPT"},
    "Misc": {"MISC"},
    "All": {"STAT", "MSTT", "FURN", "FLOR", "TREE", "GRAS", "ACTI", "DOOR", "LIGH",
            "SCEN", "REGN", "CONT", "MISC", "ALCH", "AMMO", "ARMO", "ARMA", "BOOK",
            "INGR", "KEYM", "SCRL", "SLGM", "SPEL", "WEAP", "TXST", "EFSH", "EXPL",
            "PROJ", "DEBR", "HAZD", "IDLE", "PACK", "CSTY", "LCTN", "WTHR", "CLMT",
            "WATR", "SNDR", "SNCT", "IMGS", "IMAD", "LSCR", "ANIO", "WRLD", "CELL",
            "HDPT", "HAIR", "NPC_", "RACE", "ASSET_SKIN", "ASSET_BODY"},
}
